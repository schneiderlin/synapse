(ns com.dx.agent-web.main
  (:require
   [com.dx.agent-web.render :as render :refer [render-main]]
   [com.dx.agent-web.router :as router]
   [com.dx.agent-web.actions :as actions]
   [com.dx.replicant-main.replicant.main :as rm]
   [com.dx.replicant-main.interface :as rm1]
   [com.dx.replicant-main.replicant.ws-client :as ws-client]
   [com.dx.replicant-component.interface :as replicant-component]
   [component.ai.interpolate :as ai-interpolate]
...
(def config
  {:replicant/el "app"
   ...
   :replicant/execute-actions [replicant-component/execute-action actions/execute-action]
   :ws/ws-client nil
   ...
   :replicant/render-loop {:store (ig/ref :replicant/store)
                           ...
                           :interpolate (apply rm1/make-interpolate [ai-interpolate/interpolate])
