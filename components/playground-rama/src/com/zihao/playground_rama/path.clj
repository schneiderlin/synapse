(ns com.linzihao.rama-playground.path
  (:require
   [com.rpl.rama.path :as path] 
   [com.rpl.rama :as r :refer [deframaop ?<- anchor> hook> unify> <<if else> <<cond case>
                         loop<- continue>]]
...
(comment
  ...
  (with-open [ps (rtest/create-test-pstate Object)]
    ...
    (?<-
     ...
     (r/local-select> [path/STAY] ps :> *after-first)
